...
const SessionManager = ({ initialOpenForm = false, actionTrigger, quickAction }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] bg-gradient-to-br from-gray-950 via-gray-900 to-gray-800 py-8 px-2">
      {/* Header */}
      <div className="w-full max-w-2xl mx-auto mb-8 text-center">
        <h2 className="text-3xl font-extrabold text-blue-400 drop-shadow-lg mb-2 tracking-tight">Academic Sessions</h2>
        <p className="text-base text-gray-400 mb-4">Manage sessions, release dates, and visibility</p>
        <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
          <div className="relative w-full sm:w-64">
            <input
              ...
              className="w-full px-4 py-2 rounded-xl bg-gray-800 border border-gray-700 text-gray-200 placeholder-gray-500 focus:ring-2 focus:ring-blue-400 focus:border-transparent shadow-md"
            />
          ...
          <button
            ...
            disabled={loading}
            className="bg-gray-800 hover:bg-gray-700 text-gray-200 px-5 py-2 rounded-xl font-semibold border border-gray-700 transition-all disabled:opacity-60 disabled:cursor-not-allowed shadow-md"
          ...
          <button
            ...
            className="bg-blue-500/30 hover:bg-blue-500/50 text-blue-100 px-6 py-2 rounded-xl font-semibold transition-all border border-blue-500/30 shadow-md"
          >
            + Add Session
          </button>
        </div>
